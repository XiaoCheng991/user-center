...
/** @type {import('./index').listGet} */
var listGet = function (objects, key) {
	var node = listGetNode(objects, key);
	return node && node.value;
};
/** @type {import('./index').listSet} */
var listSet = function (objects, key, value) {
	...
	if (node) {
		...
		objects.next = /** @type {import('./index').ListNode<typeof value>} */ ({ // eslint-disable-line no-param-reassign, no-extra-parens
			key: key,
			next: objects.next,
			value: value
		});
...
module.exports = function getSideChannel() {
	...
	/** @type {import('./index').RootNode<unknown>} */ var $o;
