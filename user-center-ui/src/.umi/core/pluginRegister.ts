...
import * as Plugin_2 from 'E:/AAACode/LearningProject/userManager-frontend/umiApp/src/.umi/plugin-access/rootContainer.ts';
...
import * as Plugin_6 from '../plugin-model/runtime';
  ...
  plugin.register({
    apply: Plugin_2,
    path: 'E:/AAACode/LearningProject/userManager-frontend/umiApp/src/.umi/plugin-access/rootContainer.ts',
  });
  plugin.register({
    apply: Plugin_3,
